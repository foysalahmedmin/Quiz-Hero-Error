...
// Handle Timer
/*
<> Shows the time from the start to the end of the quiz; <>
=> This function is called after 3 seconds of clicking the start quiz button and starts the quiz timer.
=> This function has a dismiss parameter. When the submit quiz button is clicked this function is called again with an argument of dismiss. And according to the condition this timer is stopped.
*/
...
/*
=> This function indicates the number of questions which option has been selected from among the quiz questions.
=> Then the question and the selected answer is stored in answers array.
*/
